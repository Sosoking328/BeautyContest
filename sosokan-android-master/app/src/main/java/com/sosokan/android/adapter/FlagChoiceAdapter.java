...
public class FlagChoiceAdapter extends RecyclerView.Adapter<FlagChoiceAdapter.MyViewHolder> {

    private Context mContext;
    private List<FlagChoice> flagChoices;
    ...
    public FlagChoiceAdapter(Context mContext, List<FlagChoice> flagChoices) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.name.setText(flagChoice.getReason());


/*
        holder.rbFlag.setOnClickListener(new View.OnClickListener() {
            @Override
...
//            holder.itemView.setBackgroundColor(mContext.getResources().getColor(R.color.rating_orange));
