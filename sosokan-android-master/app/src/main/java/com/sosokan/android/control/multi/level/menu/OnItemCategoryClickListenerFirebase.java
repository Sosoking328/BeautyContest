 ...
 */
public interface OnItemCategoryClickListenerFirebase {
     ...
     *                 on the list
     */
    void onItemClicked(MultiLevelListViewFirebase parent, View view, Object item, ItemInfo itemInfo);
     ...
     *                 on the list
     */
    void onGroupItemClicked(MultiLevelListViewFirebase parent, View view, Object item, ItemInfo itemInfo);
}