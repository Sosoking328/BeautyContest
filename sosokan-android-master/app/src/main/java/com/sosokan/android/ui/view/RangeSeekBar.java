...
import com.sosokan.android.utils.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
   ...
   /* private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.seek_thumb_normal);
    ...
    private final Bitmap thumbImage = getBitmapFromVectorDrawable(getContext(), isEnabled()? R.drawable.ic_brightness_1_orange_12dp:R.drawable.ic_brightness_1_grey_12dp);
    private final Bitmap thumbPressedImage = getBitmapFromVectorDrawable(getContext(), isEnabled()? R.drawable.ic_brightness_1_orange_24dp:R.drawable.ic_brightness_1_grey_24dp);
    private final Bitmap thumbDisabledImage = getBitmapFromVectorDrawable(getContext(), isEnabled()? R.drawable.ic_brightness_1_orange_12dp:R.drawable.ic_brightness_1_grey_24dp);
    private final Bitmap thumbImageGrey = getBitmapFromVectorDrawable(getContext(), R.drawable.ic_brightness_1_grey_12dp);
    private final Bitmap thumbPressedImageGrey = getBitmapFromVectorDrawable(getContext(), R.drawable.ic_brightness_1_grey_24dp);
    private final Bitmap thumbDisabledImageGrey = getBitmapFromVectorDrawable(getContext(), R.drawable.ic_brightness_1_grey_24dp);
    ...
    private static final int DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP = 1;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs == null) {
            ...
            setRangeValues(
                    ...
                    extractNumericValueFromAttributes(a, R.styleable.RangeSeekBar_absoluteUnitValue, DEFAULT_UNIT));
    ...
    public void setRangeValues(T minValue, T maxValue, T unitValue) {
        this.absoluteMinValue = minValue;
        this.absoluteMaxValue = maxValue;
        this.absoluteUnitValue = unitValue;
        setValuePrimAndNumberType();
    }
    ...
    private void setValuePrimAndNumberType() {
        ...
        switch (absoluteUnitValue.intValue())
        {
            case 0:
            ...
            case 1:
                unit =  getResources().getString(R.string.dollar);
                break;

            case 2:
                unit =  getResources().getString(R.string.days);
                break;
        }
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       ...
       // Log.e("onMeasure", String.valueOf(height));
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        Log.e("INITIAL_PADDING", String.valueOf(INITIAL_PADDING));
        Log.e("padding", String.valueOf(padding));
        Log.e("minMaxLabelSize ", String.valueOf(minMaxLabelSize));
        Log.e(" thumbHalfWidth", String.valueOf( thumbHalfWidth));
        Log.e(" getWidth() - padding ", String.valueOf( getWidth() - padding));
        Log.e(" normalizedMinValue ", String.valueOf(normalizedMinValue));
        Log.e(" normalizedMaxValue ", String.valueOf(normalizedMaxValue));
        ...
        int colorToUseForButtonsAndHighlightedLine = isEnabled()? getResources().getColor(R.color.orange):getResources().getColor(R.color.dark_grey_range_seek); //non default, filter is active
       ...
       // if (!selectedValuesAreDefault) {
            ...
            String minText = String.valueOf(getSelectedMinValue()) +" "+ unit;
            String maxText = String.valueOf(getSelectedMaxValue()) +" "+ unit;
            ...
            Log.e("onDraw", "minText " + String.valueOf(minText));
            Log.e("onDraw", "maxText " + String.valueOf(maxText));
    ...
    private void drawThumb(float screenCoord, boolean pressed, Canvas canvas, boolean areSelectedValuesDefault) {
        ...
        if (areSelectedValuesDefault) {
            buttonToDraw = isEnabled()?thumbDisabledImage: thumbDisabledImageGrey;
        } else {
            buttonToDraw = pressed ? isEnabled()?thumbPressedImage:thumbDisabledImageGrey : isEnabled()?thumbImage:thumbImageGrey;
        }
