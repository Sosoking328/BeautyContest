 ...
 */
public class ItemActionSpinnerAdapter extends ArrayAdapter<String> implements SpinnerAdapter {

    private Activity context;
    private String[] deer;
    private int resource;

    public ItemActionSpinnerAdapter(Activity context, int resource, String[] deer) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.name = (TextView) row.findViewById(R.id.spinnerTextAction);
            row.setTag(holder);
        } else {
