...
public class ResideMenu extends FrameLayout {
    ...
    private LinearLayout llUserProfileMenuLeft;
    ...
    public ResideMenu(Context context, String urlAvatar, String userName) {
        super(context);
        initViews(context, -1, -1, urlAvatar, userName);
        Log.e("ResideMenu userName ", "=================== " + userName);
    }

    private RoundedImageView profileImage;
    private TextView tvNameUserMenu, tvLikeUserMenu;
    ...
    public ResideMenu(Context context, int customLeftMenuId,
                      int customRightMenuId, String urlAvatar, String userName) {
        super(context);
        initViews(context, customLeftMenuId, customRightMenuId, urlAvatar, userName);
    }
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            profileImage = (RoundedImageView) scrollViewLeftMenu.findViewById(R.id.profile_image_menu);
            tvNameUserMenu = (TextView) scrollViewLeftMenu.findViewById(R.id.tvNameUserMenu);
            tvLikeUserMenu = (TextView) scrollViewLeftMenu.findViewById(R.id.tvLikeUserMenu);
            llUserProfileMenuLeft = (LinearLayout) scrollViewLeftMenu.findViewById(R.id.llUserProfileMenuLeft);
            if (profileImage != null && profileImage.getContext() != null && urlAvatar != null && !urlAvatar.isEmpty()) {
                Glide.with(profileImage.getContext()).load(urlAvatar).centerCrop()
        ...
        Log.e("tvNameUserMenu ", "=================== " + userName);
        tvNameUserMenu.setText(userName);
    ...
    public LinearLayout getLinearLayoutUserProfile() {
        return llUserProfileMenuLeft;
    }

    public RoundedImageView getProfileView() {
        return profileImage;
    }

    public TextView getNameUser() {
        return tvNameUserMenu;
    }

    public TextView getLikeUser() {
        return tvLikeUserMenu;
    }
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        this.setPadding(viewActivity.getPaddingLeft() + insets.left,
                ...
                0);
        Log.e("fitSystemWindows X", "  " + insets.bottom);
        Log.e("fitSystemWindows Y", "  " + insets.top);
    ...
    public void openMenu(int direction) {
        ...
        Log.e("mScaleValue", "  " + mScaleValue);
        Log.e("shadowAdjustScaleX", "  " + shadowAdjustScaleX);
        Log.e("shadowAdjustScaleY", "  " + shadowAdjustScaleY);
    ...
    private AnimatorSet buildScaleDownAnimation(View target, float targetScaleX, float targetScaleY) {
        ...
        Log.e("XXX", "  " + targetScaleX);
        Log.e("YYY", "  " + targetScaleY);
