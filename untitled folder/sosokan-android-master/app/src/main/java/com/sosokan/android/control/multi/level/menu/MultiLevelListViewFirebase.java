 ...
 * MultiLevelListView.
 */
public class MultiLevelListViewFirebase extends FrameLayout {
    ...
    public MultiLevelListAdapterFirebase getmAdapter() {
        return mAdapter;
    }

    private MultiLevelListAdapterFirebase mAdapter;
    private OnItemCategoryClickListenerFirebase mOnItemCategoryClickListener;
    public String categorySelectedId = Constant.sosokanCategoryAll;
    /**
     * View constructor.
     */
    public MultiLevelListViewFirebase(Context context) {
        super(context);
     ...
     * View constructor.
     */
    public MultiLevelListViewFirebase(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * View constructor.
     */
    public MultiLevelListViewFirebase(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public void setAdapter(MultiLevelListAdapterFirebase adapter) {
        if (mAdapter != null) {
            try {
     ...
     */
    public void setOnItemClickListener(OnItemCategoryClickListenerFirebase listener) {
    ...
    class OnProxyItemClickListener implements AdapterView.OnItemClickListener {
        ...
        private void notifyItemClicked(View view, Node node) {
            if (mOnItemCategoryClickListener != null) {
                mOnItemCategoryClickListener.onItemClicked(MultiLevelListViewFirebase.this, view, node.getObject(), node.getItemInfo());
            }
        }
        ...
        private void notifyGroupItemClicked(View view, Node node) {
            if (mOnItemCategoryClickListener != null) {
                mOnItemCategoryClickListener.onGroupItemClicked(MultiLevelListViewFirebase.this, view, node.getObject(), node.getItemInfo());
            }
        }
        ...
        private void onItemClicked(View view, Node node) {
            ...
            MultiLevelListAdapterFirebase.setCategorySelectedId(categorySelectedId);
