...
extension KGDrawerSpringAnimator: KGDrawerAnimating {
    public func openDrawer(_ side: KGDrawerSide, drawerView: UIView, centerView: UIView, animated: Bool, complete: (Bool) -> Void) {
        if (animated) {
    ...
    public func dismissDrawer(_ side: KGDrawerSide, drawerView: UIView, centerView: UIView, animated: Bool, complete: (_ finished: Bool) -> Void) {
        if (animated) {
            UIView.animate(withDuration: animationDuration,
                           delay: animationDelay,
                           usingSpringWithDamping: springDamping,
